...
export default function CourseCard({ displayIcon = false }) {
  return (
    ...
    >
      <div>
        <Image src="/course.png" alt="Course Image" width={300} height={183} />
      </div>
      <div className="px-3.5 flex justify-between">
        ...
        <p className="text-body-lg  text-primary-500 font-semibold ">$57</p>
      </div>
      ...
      <div className="px-3.5 flex justify-between items-center pb-3 border-t border-gray-200 pt-3">
        <div className="flex gap-1 items-center">
          ...
          <p className="text-body-md font-medium text-gray-scale-700">5.0</p>
        </div>
        <div className="flex gap-1 items-center">
          {displayIcon ? (
          ...
          <p className="text-body-md font-medium text-gray-scale-700">265.7K</p>
