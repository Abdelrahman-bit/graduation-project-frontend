...
import { Wallet, Bell, ArrowRight, Construction } from 'lucide-react';
...
export default function EarningsPage() {
   ...
   return (
      <div className="p-6 md:p-8 bg-[#F5F7FA] min-h-screen font-sans flex flex-col">
         {/* Header */}
         <div className="mb-8">
         ...
         <div className="flex-1 bg-white rounded-lg shadow-sm border border-gray-100 flex flex-col items-center justify-center p-8 text-center min-h-[500px]">
            ...
            <p className="text-gray-500 max-w-md text-base md:text-lg mb-8 leading-relaxed">
               We are currently building a comprehensive dashboard to help you
               track your course sales, revenue, and manage withdrawals
               efficiently.
            </p>
